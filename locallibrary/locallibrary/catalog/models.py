...
class Book(models.Model):
    ...
    summary = models.TextField(max_length=1000,
                               help_text='Enter a brief description of the '
                                         'book')
    ...
    def display_genre(self):
        """Create a string fo the Genre. This is required to display genre
        admin."""
...
class BookInstance(models.Model):
    """Model representing a specific copy if a book (i.e. that can be
